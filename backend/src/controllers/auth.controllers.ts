...
async function registerUser(req: AuthRequest, res: Response): Promise<Response> {
    const { fullName: { firstName, lastName }, email, password }: RegisterRequest = req.body;
...
async function loginUser(req: AuthRequest, res: Response): Promise<Response> {
